...
This module connects to a PI controller (model E861) which controls 3
...
import storm_control.sc_hardware.physikInstrumente.piE861 as piE861 
...
class PiZStageFunctionality(stageZModule.ZStageFunctionalityBuffered):
    ...
    """
    def __init__(self, update_interval = None, velocity = 1, **kwds):
        super().__init__(**kwds)
...
class PiController(stageModule.StageModule):
    def __init__(self, module_params = None, qt_settings = None, **kwds):
        ...
        self.controller = piE861.piE861() # connect to the controller 
