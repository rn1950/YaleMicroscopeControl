...
class Camera():
    ...
    def __init__(self):
       ...
       # set ROI to full sensor size:
        self._node_map.FindNode("OffsetX").SetValue(self._offset_x_min) # self._offset_x_min
        self._node_map.FindNode("OffsetY").SetValue(self._offset_y_min) # self._offset_y_min
        self._node_map.FindNode("Width").SetValue(self._width_max) # self._width_max
        self._node_map.FindNode("Height").SetValue(self._height_max) # self._height_max
