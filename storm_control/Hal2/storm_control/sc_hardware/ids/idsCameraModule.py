...
import storm_control.sc_hardware.ids.idsCamera as idsCameraInterface
...
class idsCamera(hardwareModule.HardwareModule):
    ...
    def __init__(self, module_params = None, qt_settings = None, **kwds):
        ...
        if (configuration.get("use_correlation", False)):
            ...
            self.camera = idsCameraInterface.CameraQPDCorrFit()
        ...
        #
            ...
            self.camera = idsCameraInterface.CameraQPDSAFit()

        # Use the Numpy/Scipy fitter.
        else:
            print("> using numpy/scipy for fitting.")
            self.camera = idsCameraInterface.CameraQPDScipyFit()
