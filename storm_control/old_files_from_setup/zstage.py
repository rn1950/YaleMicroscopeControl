...
# 
import sys
# sys.path.append('C:\Users\Scope3\Desktop\MicroscopeHardware\PI\PIPython-1.5.1.7 for E-873.3QTU\PIPython-1.5.1.7')
...
class piE861(object):
    ...
    #
    #
    def __init__(self, serialnum = '120014096'):   # should become a parameter, see other stages
        print(serialnum)
